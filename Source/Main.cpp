...
//==============================================================================
class __testJucerApplication  : public JUCEApplication
{
public:
    //==============================================================================
    __testJucerApplication() {}
    ...
    */
    ...
    {
    public:
        MainWindow()  : DocumentWindow ("Testing Libpd",
                                        Colours::lightgrey,
...
START_JUCE_APPLICATION (__testJucerApplication)
